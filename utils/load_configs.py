...
def get_link_prediction_args(is_evaluation: bool = False):
    ...
    parser.add_argument('--model_name', type=str, default='DyGFormer', help='name of the model, note that EdgeBank is only applicable for evaluation',
                        choices=['JODIE', 'DyRep', 'TGAT', 'TGN', 'CAWN', 'EdgeBank', 'TCL', 'GraphMixer', 'DyGFormer', 'DF2', 'Dygamba'])
    ...
    parser.add_argument('--pretrain_ratio', type=float, default=0.5, help='ratio of pretrain set')
    parser.add_argument('--finetune_ratio', type=float, default=0.2, help='ratio of finetune set')
    parser.add_argument('--tau', type=float, default=0.2, help='temperature rate')
    parser.add_argument('--embedding_dim', type=int, default=50, help='dimension of the embedding')
...
def load_link_prediction_best_configs(args: argparse.Namespace):
    ...
    if args.model_name == 'TGAT':
        ...
        if args.dataset_name in ['CanParl', 'UNtrade', 'UNvote']:
            ...
            args.sample_neighbor_strategy = 'recent'
    elif args.model_name == 'DyGFormer' or args.model_name == 'Dygamba':
        args.num_layers = 2
...
def get_node_classification_args():
    ...
    parser.add_argument('--model_name', type=str, default='DyGFormer', help='name of the model',
                        choices=['JODIE', 'DyRep', 'TGAT', 'TGN', 'CAWN', 'TCL', 'GraphMixer', 'DyGFormer','Dygamba'])
