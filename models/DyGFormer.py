...
class DyGFormer(nn.Module):
    ...
    def compute_src_dst_node_temporal_embeddings(self, src_node_ids: np.ndarray, dst_node_ids: np.ndarray, node_interact_times: np.ndarray):
        ...
        src_neighbor_delta_times = node_interact_times[:, np.newaxis] - src_padded_nodes_neighbor_times
        dst_neighbor_delta_times = node_interact_times[:, np.newaxis] - dst_padded_nodes_neighbor_times
        ...
        #
        # for mamba in self.mambaBlocks:
        #     src_patches_data = mamba(src_patches_data)
        #     dst_patches_data = mamba(dst_patches_data)
        ...
        return src_node_embeddings, dst_node_embeddings,neighbor_delta_times,src_num_patches
    ...
    def get_all_features(self, src_node_ids: np.ndarray, dst_node_ids: np.ndarray, node_interact_times: np.ndarray):
        """
         compute source and destination node temporal embeddings
         :param src_node_ids: ndarray, shape (batch_size, )
         :param dst_node_ids: ndarray, shape (batch_size, )
        ...
        dst_padded_nodes_neighbor_node_raw_features, dst_padded_nodes_edge_raw_features, dst_padded_nodes_neighbor_time_features = \
            self.get_features(node_interact_times=node_interact_times,
                              ...
                              time_encoder=self.time_encoder)
        return src_padded_nodes_neighbor_node_raw_features,src_padded_nodes_edge_raw_features,src_padded_nodes_neighbor_time_features,src_padded_nodes_neighbor_co_occurrence_features,\
    ...
    def compute_src_dst_node_temporal_embeddings_dyg(self,src_padded_nodes_neighbor_node_raw_features,src_padded_nodes_edge_raw_features,src_padded_nodes_neighbor_time_features,src_padded_nodes_neighbor_co_occurrence_features,\
               dst_padded_nodes_neighbor_node_raw_features,dst_padded_nodes_edge_raw_features,dst_padded_nodes_neighbor_time_features,dst_padded_nodes_neighbor_co_occurrence_features,neighbor_delta_times):
